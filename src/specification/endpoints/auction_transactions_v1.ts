...
export const auction_transactions_v1_endpoint: Endpoint = {
  ...
  description: "Retrieve a list of recent transactions made on the Auction House.",
  remarks: [
                  ...
                  fields: [
                    {
                      ...
                      description: "Information about the sold item is stored here."
                    },
                    {
                      name: "seller",
                    ...
                    },
                    {
                      ...
                      type: { kind: "primitive", name: "number" },
                      description: "The unix timestamp when the item was sold, in milliseconds."
                    }
                  ]
                }
              }
