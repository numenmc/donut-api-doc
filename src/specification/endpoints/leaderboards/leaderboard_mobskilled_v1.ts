...
export const leaderboard_mobs_killed_v1: Endpoint = {
  endpoint: ["v1", "leaderboards", "mobskilled", new URLParameter("page")],
  method: RequestMethod.GET,
  description: "Get the leaderboards for the most mob kills.",
  remarks: [
                ...
                schema: {
                  fields: [
                    ...player.fields,
                    {
                        ...
                        description: "The number of mob kills the player has."
                    }
                  ],
                },
              },
