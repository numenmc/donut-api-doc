  ...
  responses: [
    {
      ...
      description: "The player's location, rank and name are returned upon successful request.",
      remarks: [],
      bodyJson: {
                ...
                fields: [
                  {
                    ...
                    description:
                      "The current username of the player. This value is stored in lowercase. Bedrock edition players have a username prefixed with a period (full-stop)."
                  },
                  {
                    name: "rank",
                    type: {
                  ...
                  },
                  {
                    ...
                    description:
                      "The player's dimension. In testing, this value is always <code>Overworld</code>.",
                    unstable: true
                  }
                ]
              }
