...
export const unknownPageResponse: Response = {
  ...
  description:
    "The API does not complete the query because the specified page is out of bounds.",
  remarks: [],
  bodyJson: {
    ...
    fields: [
      ...
      },
      {
        ...
        description: "Despite the upstream API returning a server error, the error described here is a client error. This behaviour is documented as-is from the upstream API.",
        unstable: true
      },
    ],
  },
