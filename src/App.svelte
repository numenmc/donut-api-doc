<script lang="ts">
  ...
  import { ExclamationCircleFill, Github, QuestionCircleFill } from "svelte-bootstrap-icons";
  ...
  <Container fluid class="pt-5 pb-5" style="max-width: 1500px;">
    <Row class="g-4">
      <Col md="4" lg="3">
        <div class="sticky">
          <ListGroup class="mb-4">
            {#each specification.endpoints as endpoint (getEndpointId(endpoint))}
              <ListGroupItem tag="a" href={`#${getEndpointId(endpoint)}`} action>
          ...
          <div class="mb-4">
            ...
            <a
              ...
              href="https://github.com/numenmc/donut-api-doc/issues"
            >
              <Github class="icon mr-1"></Github>
              Issues
            </a>
          ...
          <p style="font-size: 8pt; letter-spacing: 5%; margin-left: 0.3em; margin-right: 0.3em;">
            <a href="/.vite/license.md">Third Party Notices</a>
          </p>

          <p style="font-size: 8pt; letter-spacing: 5%; margin-left: 0.3em; margin-right: 0.3em;">
            This website is not affiliated with, endorsed by, or sponsored by DonutSMP or Minecraft.
          </p>
        </div>
      </Col>
      ...
      <Col md="8" lg="9">
        ...
        <p class="lead">
          Below is the community maintained version of the API documentation form the DonutSMP Data
          API. If you're looking for the original documentation, it can be viewed at <a
            href="https://api.donutsmp.net">https://api.donutsmp.net</a
          >.
        </p>
        ...
        <Alert color="info">
          <QuestionCircleFill class="icon r"></QuestionCircleFill>
          Looking for Shield endpoints? They aren't documented here because they are for internal use
          only.
        </Alert>
        <Alert color="warning">
          <ExclamationCircleFill class="icon r"></ExclamationCircleFill>
          Much of this documentation diverges from REST/OpenAPI conventions. These behaviours originate
          from the upstream API and are documented as-is.
        </Alert>

        <p class="lead">
          To use the endpoints you must retrieve an API key using <code>/api</code>
          in-game and supply it to the <code>Authorization</code> header as a bearer token.
        </p>
